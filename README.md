...
Eight small C++ CLI tools + a launcher:
...
- `simbriefBrief/`: SimBrief summarizer. Reads an OFP XML, prints key flight/fuel/route/weight info, and can output a verticalProfile-ready `route_sample.csv`.
